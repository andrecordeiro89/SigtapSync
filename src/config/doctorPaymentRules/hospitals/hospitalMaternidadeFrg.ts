...
const UROLOGIA_FRG_RULES: Omit<DoctorPaymentRule, 'doctorName'> = {
  rules: [
    ...
    { procedureCode: '04.09.02.017-6', standardValue: 250.00, secondaryValue: 200.00, tertiaryValue: 175.00, quaternaryValue: 150.00, description: 'URETROTOMIA INTERNA - Principal: R$ 250 | 2º: R$ 200 | 3º: R$ 175 | 4º: R$ 150' },
