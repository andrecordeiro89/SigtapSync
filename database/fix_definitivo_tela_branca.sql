-- ================================================
-- FIX DEFINITIVO: TELA BRANCA - SOLUÇÃO COMPLETA
-- ================================================
...
-- PASSO 6: Inserir usuários demo + SEU usuário específico
...
('32568fe0-b744-4a15-97a4-b54ed0b0610e', 'usuario.principal@sistema.com', 'developer', 'Usuário Principal', ARRAY['all'], ARRAY[]),

-- Usuários demo para backup
('11111111-1111-1111-1111-111111111111', 'dev@demo.com', 'developer', 'Developer Demo', ARRAY['all'], ARRAY[]),
('22222222-2222-2222-2222-222222222222', 'admin@demo.com', 'admin', 'Admin Demo', ARRAY['patients_manage', 'procedures_manage', 'reports_view'], ARRAY[]),
('33333333-3333-3333-3333-333333333333', 'user@demo.com', 'user', 'User Demo', ARRAY['patients_view', 'reports_view'], ARRAY[])
