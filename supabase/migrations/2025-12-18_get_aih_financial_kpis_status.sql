create or replace function public.get_aih_financial_kpis(
  ...
  match_statuses text[] default null,
  billing_statuses text[] default null
) returns table(
...
as $$
  with base as (
    ...
    where (hospital_ids is null or a.hospital_id = any (hospital_ids))
      ...
      and (match_statuses is null or pr.match_status = any (match_statuses))
      and (billing_statuses is null or pr.billing_status = any (billing_statuses))
