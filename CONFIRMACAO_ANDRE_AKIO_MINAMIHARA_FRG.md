# ✅ CONFIRMAÇÃO - DR. ANDRÉ AKIO MINAMIHARA
...
| Campo | Valor |
|-------|-------|
| **Nome Completo** | ANDRÉ AKIO MINAMIHARA |
...
O Dr. André Akio Minamihara agora possui **2 combinações diferentes**:
...
## 📌 **OUTROS MÉDICOS COM REGRAS SIMILARES**

A mesma regra de **Luxação Recidivante (R$ 500,00)** foi implementada para:

| Médico | Hospital | Código | Status |
|--------|----------|--------|--------|
| **BRUNO BOSIO DA SILVA** | Torao Tokuda | APU | ✅ Implementado |
| **BRUNO BOSIO DA SILVA** | 18 de Dezembro | ARA | ✅ Implementado |
| **ANDRÉ AKIO MINAMIHARA** | Maternidade FRG | FRG | ✅ **NOVO!** |
...
```
1. Sistema recebe:
   ├─ Nome do médico: 'ANDRÉ AKIO MINAMIHARA'
...
3. Sistema busca regra:
   └─ DOCTOR_PAYMENT_RULES_BY_HOSPITAL['HOSPITAL_MATERNIDADE_NOSSA_SENHORA_APARECIDA_FRG']['ANDRÉ AKIO MINAMIHARA']
...
|------|--------|----------|-----------|--------|
| 19/11/2025 | ANDRÉ AKIO MINAMIHARA | Maternidade FRG | Regra Manguito Rotador (R$ 900) | ✅ Implementada |
| 21/11/2025 | ANDRÉ AKIO MINAMIHARA | Maternidade FRG | Regra Luxação Recidivante (R$ 500) | ✅ **NOVA!** |
...
3. **Dentro dessa seção, buscar:** `'ANDRÉ AKIO MINAMIHARA'` (linha ~5771)
...
O Dr. **ANDRÉ AKIO MINAMIHARA** no **Hospital Maternidade Nossa Senhora Aparecida (FRG)** agora tem a regra de **Luxação Recidivante de Ombro** onde a combinação de:
